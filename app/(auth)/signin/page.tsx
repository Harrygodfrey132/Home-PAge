...
import CustomerAvatar from '@/public/images/customer-avatar-03.jpg'
        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          ...
          <div className="px-5 sm:px-6 py-8">
            <div className="w-full max-w-md mx-auto">
              ...
              <h1 className="h2 font-playfair-display text-slate-800 mb-12">Sign in to The Blissful Moments</h1>
              {/* Social login */}
              <div className="space-y-3">
                <button className="btn-sm p-0 text-white bg-gray-500 hover:bg-navy-500 w-full relative flex items-stretch">
                  <div className="flex items-center bg-gray-500 mr-4">
                    <svg className="w-4 h-4 fill-current text--100 shrink-0 mx-3" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7.9 7v2.4H12c-.2 1-1.2 3-4 3-2.4 0-4.3-2-4.3-4.4 0-2.4 2-4.4 4.3-4.4 1.4 0 2.3.6 2.8 1.1l1.9-1.8C11.5 1.7 9.9 1 8 1 4.1 1 1 4.1 1 8s3.1 7 7 7c4 0 6.7-2.8 6.7-6.8 0-.5 0-.8-.1-1.2H7.9z" />
                    </svg>
                  </div>
                  <span className="flex-auto text-navy-500 text-sm py-2 pl-14 pr-8 -ml-14">Login with Google</span>
                </button>
        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          <div className="px-5 sm:px-6">
            <div className="w-full max-w-lg mx-auto">
              <h2 className="h3 md:text-4xl font-playfair-display text-slate-100 mb-4">The Blissful Moments</h2>
              <div className="space-y-3">
...
I founded this QR memorial page business to honor the legacies of those we’ve lost, inspired by my own grandfather, whose stories I never fully got to know. My goal is to help families preserve the memories and stories that truly define their loved ones, ensuring their legacies live on and continue to inspire future generations.</blockquote>
              </div>
              <div className="flex items-center mt-4">
                ...
                <div className="font-medium">
                  <span className="text-slate-200">Harry</span>
                  <span className="text-slate-600"> · </span>
                  <span className="text-slate-500">Founder, The Blissful Moments</span>
                </div>
              </div>
            </div>
          </div>
